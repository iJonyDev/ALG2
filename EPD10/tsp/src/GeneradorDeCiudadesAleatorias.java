...
public class GeneradorDeCiudadesAleatorias {
	...
	private final int NUM_CITIES = 8; // Number of cities to generate
	private ArrayList<Point> cities; // List of city coordinates
	public int[][] matrix; // Distance matrix
	public final int MAX_EUCLID = 20; // Coordinate space max X and max Y
	Random rand; // Random numbers
	private final String OUTPUT_FILENAME = "TSP08.txt";
