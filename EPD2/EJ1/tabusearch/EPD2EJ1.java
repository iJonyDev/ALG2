...
public class EPD2EJ1 {
    ...
    public static final int[] PESOS = { 90, 60, 50, 30, 40 };
    public static final int[] BENEFICIOS = { 100, 200, 150, 50, 20 };
    ...
    public static Solucion tabuSearch() {
        // Solucion solActual = new Solucion(); // Puesto así para mostrar que hay dos
        // constructores
    ...
    private static boolean criterioAspiracion(Solucion solMejor, Solucion vecino, Solucion vecinoMejor) {
        ...
        if (vecino.getCoste() > solMejor.getCoste() && vecino.getCoste() > vecinoMejor.getCoste()) { // Controlamos que
                                                                                                     // no se haya
                                                                                                     // encontrado el
                                                                                                     // mejor entre los
                                                                                                     // vecinos ya
    ...
    private static Solucion seleccionarMejorVecino(Solucion[] vecinos, Solucion solMejor,
            ArrayList<Solucion> listaTabu) {
