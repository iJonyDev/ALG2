...
public class SA_ej2_2 {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("\n\nValor maximo encontrado es x=" + binaryToDecimal(solucion) + ", siendo f(x)=" + calcularCoste(solucion));
    }
    ...
    private static int[] enfriamientoSimulado(){
        ...
        while (temperatura >= T_FINAL && exitos != 0){
            exitos = 0;
            System.out.println("\n*******************\nSolucion actual para este iteracion es: " + binaryToDecimal(solActual) + "\n");
        ...
        if(exitos == 0){
            System.out.println("\nSe termina el proceso de busqueda por no haber mejorer vecinos");
        }else{
