...
public class SA_ej3_2 {
    ...
    public static void main(String[] args){
        ...
        System.out.println("\nPesos de los elementos: " + Arrays.toString(PESOS));
        System.out.println("\nBeneficios de los elemento: " + Arrays.toString(BENEFICIOS));
        int[] solucion = enfriamientoSimulado();
        System.out.println("\nValor maximo encontrado x=" + binaryToDecimal(solucion) + ", siendo f(x)=" + calcularCoste(solucion));
    }
    ...
    public static int[] enfriamientoSimulado(){
        ...
        while(temperatura > T_FINAL && exitos != 0){
            exitos = 0;
            System.out.println("\n*******************\nSolucion actual para este iteracion: " + binaryToDecimal(solActual) + "\n");
            ...
            System.out.println("Solucion mejor para este iteracion: " + binaryToDecimal(solMejor) + "\n");
            temperatura *= 0.9;
        }
        if(exitos == 0){
            System.out.println("\nSe termina el proceso por no haber mejores vecinos");
        }else{
            System.out.println("\nSe termina el proceso por enfriarse el proceso");
        }
        return solMejor;
    }
